-- ========================================
-- 外装アイテムシードデータ（カテゴリ連携版）
-- ========================================
-- 実行前提: 003_seed_categories.sql が実行済みであること
-- ========================================
...
INSERT INTO items (category_id, item_code, name, category_name, manufacturer, model_number, note, is_hit, is_active)
SELECT c.id, 'NICHIHA-MONABI-001', 'モナビストーンV', '窯業系サイディング', 'ニチハ', 'モエンエクセラード16 Vシリーズ', '16mm厚・横張のみ・マイクロガード塗装', false, true
FROM categories c WHERE c.slug = 'exterior-wall-nichiha-std'
...
-- シャルムロックV
INSERT INTO items (category_id, item_code, name, category_name, manufacturer, model_number, note, is_hit, is_active)
SELECT c.id, 'NICHIHA-CHARM-001', 'シャルムロックV', '窯業系サイディング', 'ニチハ', 'モエンエクセラード16 Vシリーズ', '16mm厚・マイクロガード塗装', false, true
FROM categories c WHERE c.slug = 'exterior-wall-nichiha-std'
ON CONFLICT (item_code) DO NOTHING;
...
-- リーガストーン調V
INSERT INTO items (category_id, item_code, name, category_name, manufacturer, model_number, note, is_hit, is_active)
SELECT c.id, 'NICHIHA-REGA-001', 'リーガストーン調V', '窯業系サイディング', 'ニチハ', 'モエンエクセラード16 Vシリーズ', '16mm厚・マイクロガード塗装', false, true
FROM categories c WHERE c.slug = 'exterior-wall-nichiha-std'
ON CONFLICT (item_code) DO NOTHING;
...
-- ディスタシェイドV
INSERT INTO items (category_id, item_code, name, category_name, manufacturer, model_number, note, is_hit, is_active)
SELECT c.id, 'NICHIHA-DISTA-001', 'ディスタシェイドV', '窯業系サイディング', 'ニチハ', 'モエンエクセラード16 Vシリーズ', '16mm厚・マイクロガード塗装', false, true
FROM categories c WHERE c.slug = 'exterior-wall-nichiha-std'
ON CONFLICT (item_code) DO NOTHING;
...
-- グレインウッドV
INSERT INTO items (category_id, item_code, name, category_name, manufacturer, model_number, note, is_hit, is_active)
SELECT c.id, 'NICHIHA-GRAIN-001', 'グレインウッドV', '窯業系サイディング', 'ニチハ', 'モエンエクセラード16 Vシリーズ', '16mm厚・マイクロガード塗装', false, true
FROM categories c WHERE c.slug = 'exterior-wall-nichiha-std'
ON CONFLICT (item_code) DO NOTHING;
...
-- スティルランバー プレミアム
INSERT INTO items (category_id, item_code, name, category_name, manufacturer, model_number, note, is_hit, is_active)
SELECT c.id, 'NICHIHA-STIL-PREM-001', 'スティルランバー プレミアム', '窯業系サイディング', 'ニチハ', 'モエンエクセラード16 プレミアムシリーズ Fu-ge', '16mm厚・プラチナコート・マイクロガード・四方合いじゃくり', false, true
FROM categories c WHERE c.slug = 'exterior-wall-nichiha-premium'
ON CONFLICT (item_code) DO NOTHING;
...
-- ミルシュタイン プレミアム
INSERT INTO items (category_id, item_code, name, category_name, manufacturer, model_number, note, is_hit, is_active)
SELECT c.id, 'NICHIHA-MILS-PREM-001', 'ミルシュタイン プレミアム', '窯業系サイディング', 'ニチハ', 'モエンエクセラード16 プレミアムシリーズ Fu-ge', '16mm厚・プラチナコート・マイクロガード', false, true
FROM categories c WHERE c.slug = 'exterior-wall-nichiha-premium'
ON CONFLICT (item_code) DO NOTHING;
...
-- ハーモレイド
INSERT INTO items (category_id, item_code, name, category_name, manufacturer, model_number, note, is_hit, is_active)
SELECT c.id, 'KMEW-HARMO-001', 'ハーモレイド', '窯業系サイディング', 'KMEW', 'ネオロック・光セラ18 (18mm厚)', '光セラ・マイクロガード・横張のみ', false, true
FROM categories c WHERE c.slug = 'exterior-wall-kmew'
ON CONFLICT (item_code) DO NOTHING;
...
-- モダンスリット18
INSERT INTO items (category_id, item_code, name, category_name, manufacturer, model_number, note, is_hit, is_active)
SELECT c.id, 'KMEW-MODERN-001', 'モダンスリット18', '窯業系サイディング', 'KMEW', 'ネオロック・光セラ18 (18mm厚)', '光セラ・横張のみ', false, true
FROM categories c WHERE c.slug = 'exterior-wall-kmew'
ON CONFLICT (item_code) DO NOTHING;
...
-- SPビレクト
INSERT INTO items (category_id, item_code, name, category_name, manufacturer, model_number, note, is_hit, is_active)
SELECT c.id, 'IG-SPBILECT-001', 'SPビレクト', '金属サイディング', 'IG工業', 'SPビレクト1', '変褪色・穴あき・赤さび10年保証・横張のみ', false, true
FROM categories c WHERE c.slug = 'exterior-wall-ig'
ON CONFLICT (item_code) DO NOTHING;
...
-- ガルスパン
INSERT INTO items (category_id, item_code, name, category_name, manufacturer, model_number, note, is_hit, is_active)
SELECT c.id, 'IG-GARUSPAN-001', 'ガルスパン', '金属サイディング', 'IG工業', 'ガルスパン2', '変褪色・穴あき・赤さび10年保証・横張のみ', false, true
FROM categories c WHERE c.slug = 'exterior-wall-ig'
ON CONFLICT (item_code) DO NOTHING;
...
-- エンシェントブリック
INSERT INTO items (category_id, item_code, name, category_name, manufacturer, model_number, note, is_hit, is_active)
SELECT c.id, 'AICA-ANCIENT-001', 'エンシェントブリック', '塗り壁', 'AICA', 'ジョリパットネオJQ-620', '筋が出やすく目立つことがあります', false, true
FROM categories c WHERE c.slug = 'exterior-wall-aica'
ON CONFLICT (item_code) DO NOTHING;
...
-- 003_seed_categories.sqlに'exterior-wall-solido'が追加されている場合
INSERT INTO items (category_id, item_code, name, category_name, manufacturer, model_number, note, is_hit, is_active)
SELECT c.id, 'KMEW-SOLIDO-001', 'SOLIDO typeM_LAP', '窯業系サイディング', 'KMEW', 'SOLIDO', '不燃材料NM-4601(1)・窯業系平形スレート・5㎡以下は一式金額', false, true
FROM categories c WHERE c.slug = 'exterior-wall-solido'
ON CONFLICT (item_code) DO NOTHING;
...
INSERT INTO items (category_id, item_code, name, category_name, manufacturer, model_number, note, is_hit, is_active)
SELECT c.id, 'PORCH-MORTAR-001', 'モルタル金鏝抑え', 'ポーチ', '-', '-', '将来的に乾燥収縮によりヘアークラック（ひび割れ）がおこる可能性あり・標準1.8m×1.8m', false, true
FROM categories c WHERE c.slug = 'porch-mortar'
ON CONFLICT (item_code) DO NOTHING;
...
INSERT INTO items (category_id, item_code, name, category_name, manufacturer, model_number, note, is_hit, is_active)
SELECT c.id, 'PORCH-NATURE2-001', 'ネイチャーII', 'ポーチタイル', '名古屋モザイク', '300×300', 'タイル目地色選択可能（白・灰・濃灰・黒）', true, true
FROM categories c WHERE c.slug = 'porch-nagoya-mosaic'
ON CONFLICT (item_code) DO NOTHING;
...
INSERT INTO items (category_id, item_code, name, category_name, manufacturer, model_number, note, is_hit, is_active)
SELECT c.id, 'PORCH-VESPA-001', 'ベスパ', 'ポーチタイル', 'LIXIL', '300×300', 'タイル目地色選択可能', true, true
FROM categories c WHERE c.slug = 'porch-lixil'
ON CONFLICT (item_code) DO NOTHING;
...
INSERT INTO items (category_id, item_code, name, category_name, manufacturer, model_number, note, is_hit, is_active)
SELECT c.id, 'ROOF-NISQSGL-001', 'ニスクカラーSGL', '屋根材', '日鉄鋼板', 'RK001S', '材料標準保証10年・不燃材料NM-8697・海岸500m以遠原板穴あき25年保証', false, true
FROM categories c WHERE c.slug = 'roof'
ON CONFLICT (item_code) DO NOTHING;
...
INSERT INTO items (category_id, item_code, name, category_name, manufacturer, model_number, note, is_hit, is_active)
SELECT c.id, 'GUTTER-FINE-001', 'ファインスケアNF-I型', '横樋', 'Panasonic', 'ファインスケア', '標準', false, true
FROM categories c WHERE c.slug = 'gutter'
ON CONFLICT (item_code) DO NOTHING;
...
INSERT INTO items (category_id, item_code, name, category_name, manufacturer, model_number, note, is_hit, is_active)
SELECT c.id, 'GUTTER-S30-001', 'S30', '縦樋', 'Panasonic', 'S30', '標準', false, true
FROM categories c WHERE c.slug = 'gutter'
ON CONFLICT (item_code) DO NOTHING;
...
INSERT INTO items (category_id, item_code, name, category_name, manufacturer, model_number, note, is_hit, is_active)
SELECT c.id, 'SOFFIT-EMBOSS-001', 'エンボス', '軒天', '神島化学', 'エンボス', '標準', false, true
FROM categories c WHERE c.slug = 'soffit'
ON CONFLICT (item_code) DO NOTHING;
...
INSERT INTO items (category_id, item_code, name, category_name, manufacturer, model_number, note, is_hit, is_active)
SELECT c.id, 'WINDOW-APW330-001', 'APW330', '窓サッシ', 'YKKAP', 'APW330', '樹脂サッシ・アルゴンガス・ペアガラス・防火/非防火・熱貫流率1.31W/(㎡・K)', false, true
FROM categories c WHERE c.slug = 'window-apw330'
ON CONFLICT (item_code) DO NOTHING;
...
INSERT INTO items (category_id, item_code, name, category_name, manufacturer, model_number, note, is_hit, is_active)
SELECT c.id, 'WINDOW-APW430-001', 'APW430', '窓サッシ', 'YKKAP', 'APW430', '樹脂サッシ・アルゴンガス・トリプルガラス・防火/非防火・熱貫流率0.90W/(㎡・K)', false, true
FROM categories c WHERE c.slug = 'window-apw430'
ON CONFLICT (item_code) DO NOTHING;
...
INSERT INTO items (category_id, item_code, name, category_name, manufacturer, model_number, note, is_hit, is_active)
SELECT c.id, 'DOOR-VENATO-001', 'ヴェナートD30', '玄関ドア', 'YKKAP', 'ヴェナートD30', '防火/非防火・100V電気錠・ポケットキー標準（LIFE+/LACIE/HOURS）', false, true
FROM categories c WHERE c.slug = 'entrance-door'
ON CONFLICT (item_code) DO NOTHING;
...
INSERT INTO items (category_id, item_code, name, category_name, manufacturer, model_number, note, is_hit, is_active)
SELECT c.id, 'AWNING-AD2S-001', 'アルフィン庇 AD2S', '庇', 'アルフィン', 'AD2S', 'W1800×D900', false, true
FROM categories c WHERE c.slug = 'awning'
ON CONFLICT (item_code) DO NOTHING;
...
INSERT INTO items (category_id, item_code, name, category_name, manufacturer, model_number, note, is_hit, is_active)
SELECT c.id, 'SHUTTER-SANWA-001', 'サンオートハイスピード', '電動シャッター', '三和シャッター', 'サンオートハイスピード', 'W2550 H2200・非防火・シャッター開放約13秒・障害物検知装置付き', false, true
FROM categories c WHERE c.slug = 'shutter'
ON CONFLICT (item_code) DO NOTHING;
...
INSERT INTO items (category_id, item_code, name, category_name, manufacturer, model_number, note, is_hit, is_active)
SELECT c.id, 'ECOCUTE-PANA-001', 'エコキュート 370L', '給湯設備', 'Panasonic', 'HE-S37LQS', 'Sシリーズ・標準370L・1810×600×680', false, true
FROM categories c WHERE c.slug = 'exterior-equipment'
ON CONFLICT (item_code) DO NOTHING;
